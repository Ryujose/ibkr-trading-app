...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 30, 173, -1, sizeof(::protobuf::Order)},
};
...
const ::_pbi::DescriptorTable descriptor_table_Order_2eproto = {
    false, false, 7108, descriptor_table_protodef_Order_2eproto,
    "Order.proto",
...
uint8_t* Order::_InternalSerialize(
  ...
  if (_internal_has_routemarketabletobbo()) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(120, this->_internal_routemarketabletobbo(), target);
  }
